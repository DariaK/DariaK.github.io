tyrano.plugin.kag.menu = {
    tyrano: null, kag: null, snap: null, init: function () {
        ...
        this.kag.html("save", {array_save: array, novel: $.novel}, (function (html_str) {
            ...
            j_save.find(".save_display_area").each((function () {
                $(this).click((function (e) {
                    ...
                    that.doSave(num, (function (save_data) {
                        ...
                        if ("" != save_data.img_data) if (j_slot.find(".save_list_item_thumb").find("img").get(0)) j_slot.find(".save_list_item_thumb").find("img").attr("src", save_data.img_data); else {
            ...
            if ("pc" != $.userenv()) {
                ...
                j_save.find(".button_arrow_up").click((function () {
                    ...
                    layer_menu.find(".area_save_list").animate({scrollTop: pos}, {queue: !1})
                }));
                j_save.find(".button_arrow_down").click((function () {
                    var pos = j_save.find(".area_save_list").scrollTop() + 160;
                    j_save.find(".area_save_list").animate({scrollTop: pos}, {queue: !1})
                }))
            }
        ...
        var that = this, saveTitle = that.kag.stat.current_save_str;
        ...
        var that = this, _current_order_index = that.kag.ftag.current_order_index - 1,
            _stat = $.extend(!0, {}, $.cloneObject(that.kag.stat)), models = (three = this.kag.tmp.three).models,
            three_save = {};
        three_save.stat = three.stat;
        three_save.evt = three.evt;
        var three = this.kag.tmp.three, save_models = {};
        ...
        if ("false" == flag_thumb) {
            ...
            setTimeout((function () {
                ...
                if ("" != that.kag.stat.save_img) {
                    ...
                    let w, h, canvas = document.createElement("canvas"), ctx = canvas.getContext("2d"),
        ...
        var auto_next = "no";
        void 0 === options ? options = {bgm_over: "false"} : void 0 === options.bgm_over && (options.bgm_over = "false");
        options.auto_next && (auto_next = options.auto_next);
        if ("undefined" != typeof Live2Dcanvas) for (model_id in Live2Dcanvas) if (Live2Dcanvas[model_id]) {
        ...
        if ("false" == options.bgm_over) {
            ...
            for (var key in map_se) map_se[key] && this.kag.ftag.startTag("stopse", {stop: "true", buf: key});
            var map_bgm = this.kag.tmp.map_bgm;
            for (var key in map_bgm) this.kag.ftag.startTag("stopbgm", {stop: "true", buf: key});
        ...
        if (this.kag.stat.cssload) for (file in this.kag.stat.cssload) {
        ...
        this.kag.stat.current_bgmovie || (this.kag.stat.current_bgmovie = {storage: "", volume: ""});
        if ("true" == this.kag.config.useCamera) {
            ...
            for (key in this.kag.stat.current_camera) {
                var a3d_define = {
                    ...
                    }, config: {duration: "5ms", state: "running", easing: "ease"}, complete: function () {
                    }
                };
                if ("layer_camera" == key) {
        ...
        if (1 == three.stat.is_load) {
            ...
            var models = three.models, scene_pm = three.stat.scene_pm;
            scene_pm.next = "false";
        ...
        $(".event-setting-element").each((function () {
            var j_elm = $(this), kind = j_elm.attr("data-event-tag"), pm = JSON.parse(j_elm.attr("data-event-pm"));
        ...
        this.kag.html("backlog", {novel: $.novel}, (function (html_str) {
            var j_menu = $(html_str), layer_menu = that.kag.layer.getMenuLayer();
            layer_menu.empty();
            layer_menu.append(j_menu);
            ...
            if ("pc" != $.userenv()) {
                ...
                layer_menu.find(".button_arrow_up").click((function () {
                    ...
                    layer_menu.find(".log_body").animate({scrollTop: pos}, {queue: !1})
                }));
